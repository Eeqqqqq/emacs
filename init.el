...
(custom-set-variables
 ...
 '(package-selected-packages
   '(ccls windresize unicad treemacs-projectile treemacs-evil all-the-icons magit ggtags counsel-gtags neotree ox-hugo lsp-client eglot company-lsp monokai-theme almost-mono-themes doom-theme spacemacs-theme htmlize html-to-markdown auto-org-md dracula-theme doom-themes which-key dap-mode lsp-clients company-prescient company-quickhelp company counsel swiper use-package lsp-mode))
